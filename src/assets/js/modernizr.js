window.Modernizr = function(e, t, n) {
  ...
  function s(e, t, n) {
    ...
    return o(t, "string") || o(t, "undefined") ? a(i, t) : (i = (e + " " + j.join(r + " ") + r).split(" "),
    c(i, t, n))
  }
  var l, u, f, d = "2.8.3", p = {}, m = !0, h = t.documentElement, v = "modernizr-fabbcb80", y = t.createElement(v), g = y.style, b = ({}.toString,
  " -webkit- -moz- -o- -ms- ".split(" ")), E = "Webkit Moz O ms", w = E.split(" "), j = E.toLowerCase().split(" "), C = {
    svg: "http://www.w3.org/2000/svg"
  }, S = {}, x = [], N = x.slice, T = function(e, n, r, o) {
  ...
  S.touch = function() {
    var n;
    return "ontouchstart"in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : T(["@media (", b.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
      n = 9 === e.offsetTop
    }),
    n
  }
  ...
  S.csstransforms3d = function() {
    var e = !!s("perspective");
    return e && "webkitPerspective"in h.style && T("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t) {
  ...
  function(e, t) {
    ...
    function i(e, n, r) {
      ...
      !i.canHaveChildren || p.test(e) || i.tagUrn ? i : r.frag.appendChild(i)
    }
    function a(e, n) {
      if (e || (e = t),
      u)
    ...
    function s(e) {
      e || (e = t);
      var r = o(e);
      return g.shivCSS && !l && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
      u || c(e, r),
      e
    }
    var l, u, f = "3.7.0", d = e.html5 || {}, p = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, m = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, h = "_html5shiv", v = 0, y = {};
    !function() {
      try {
  ...
  ,
  h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? "js " + x.join(" ") : ""),
  p
}(this, this.document),
function(e, t, n) {
  function r(e) {
  ...
  function s(e, n, r, o, i, s, l) {
    ...
    ,
    y.splice(o, 0, b),
    "img" != e && (v || 2 === N[n] ? (w.insertBefore(f, E ? null : h),
    m(u, l)) : N[n].push(f))
  }
  function l(e, t, n, r, i) {
    return g = 0,
    t = t || "j",
    o(e) ? s("c" == t ? C : j, e, t, this.i++, n, r, i) : (y.splice(this.i++, 0, e),
    1 == y.length && c()),
    this
  }
  function u() {
  ...
  var f, d, p = t.documentElement, m = e.setTimeout, h = t.getElementsByTagName("script")[0], v = {}.toString, y = [], g = 0, b = "MozAppearance"in p.style, E = b && !!t.createRange().compareNode, w = E ? p : h.parentNode, p = e.opera && "[object Opera]" == v.call(e.opera), p = !!t.attachEvent && !p, j = b ? "object" : p ? "script" : "img", C = p ? "script" : j, S = Array.isArray || function(e) {
  ...
  d = function(e) {
    ...
    function a(e, o, i, a, c) {
      ...
      s.instead ? s.instead(e, o, i, a, c) : (N[s.url] ? s.noexec = !0 : N[s.url] = 1,
    ...
    if (o(e))
      ...
      for (s = 0; s < e.length; s++)
        l = e[s],
        o(l) ? a(l, 0, f, 0) : S(l) ? d(l) : Object(l) === l && c(l, f);
    else
      Object(e) === e && c(e, f)
  }
  ,
